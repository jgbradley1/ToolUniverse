...
result2 = tu.run(
    {"name": "Tool_Finder_Keyword", "arguments": {"description": "disease", "limit": 3}}
)
...
discovery_queries = [
    ...
    },
    {
        ...
        "arguments": {"description": "protein", "limit": 2},
    },
    {
        "name": "Tool_Finder",
        "arguments": {
...
result_rag = tu.run(
    {
        "name": "Tool_RAG",
        "arguments": {"description": "Find tools for gene prediction.", "limit": 2},
    }
)
print("\n[Tool_RAG] Result:")
print(result_rag)
