...
def main():
    ...
    result = tu.run(
        {"name": "EMDB_get_structure", "arguments": {"emdb_id": "EMD-1234"}}
    )
    ...
    result = tu.run(
        {"name": "EMDB_get_structure", "arguments": {"emdb_id": "EMD-0001"}}
    )
    ...
    result = tu.run(
        {"name": "EMDB_get_structure", "arguments": {"emdb_id": "EMD-1000"}}
    )
