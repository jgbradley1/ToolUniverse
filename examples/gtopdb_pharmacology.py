...
def main():
    ...
    result = tu.run({"name": "GtoPdb_get_targets", "arguments": {"limit": 5}})
    ...
    result = tu.run({"name": "GtoPdb_get_targets", "arguments": {"limit": 8}})
    ...
    result = tu.run({"name": "GtoPdb_get_targets", "arguments": {"limit": 3}})
