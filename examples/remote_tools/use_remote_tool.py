...
def test_basic_usage(tu, tool_name):
    ...
    test_cases = [
        {"text": "Hello World", "operation": "uppercase", "expected": "HELLO WORLD"},
        {
            "text": "Python Programming",
            "operation": "lowercase",
            "expected": "python programming",
        },
        {"text": "ToolUniverse", "operation": "reverse", "expected": "esrevinUlooT"},
        {"text": "This is a test sentence", "operation": "word_count", "expected": "5"},
        {"text": "Hello", "operation": "char_count", "expected": "5"},
    ]
...
def test_direct_access(tu, tool_name):
    ...
    try:
        ...
        result = tool_callable(text="Direct Access Test", operation="uppercase")
...
def test_error_handling(tu, tool_name):
    ...
    error_cases = [
        {"text": "", "operation": "uppercase", "description": "Empty text"},
        {
            "text": "Test",
    ...
    for i, case in enumerate(error_cases, 1):
        try:
            ...
            result = tu.run({"name": tool_name, "arguments": case})
...
def main():
    ...
    try:
        ...
        print(
            f"✅ Loaded {len(remote_tools)} remote tool(s): {', '.join(remote_tools) or 'None'}"
        )
