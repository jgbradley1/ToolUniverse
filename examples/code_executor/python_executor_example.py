    ...
    result = tu.run(
        {
            ...
            "arguments": {"code": "result = sum([1, 2, 3, 4, 5])", "timeout": 10},
        }
    )
...
""",
    ...
    result = tu.run(
        {
            "name": "python_code_executor",
            "arguments": {"code": "result = open('test.txt', 'w')", "timeout": 10},
        }
    )
    print(f"Result: {result}")
    ...
    result = tu.run(
        {
            "name": "python_code_executor",
            "arguments": {"code": "while True: pass", "timeout": 2},
        }
    )
    print(f"Result: {result}")
...
def demonstrate_script_runner(tu):
    ...
    try:
        ...
        result = tu.run(
            {
                ...
                "arguments": {"script_path": script_path, "timeout": 30},
            }
        )
        print(f"Result: {result}")
        ...
        result = tu.run(
            {
                "name": "python_script_runner",
                "arguments": {"script_path": "/nonexistent/script.py", "timeout": 30},
            }
        )
        print(f"Result: {result}")
