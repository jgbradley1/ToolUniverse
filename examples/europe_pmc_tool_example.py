...
result2 = tu.run(
    {
        "name": "EuropePMC_search_articles",
        "arguments": {"query": "machine learning", "limit": 5, "sort_by": "relevance"},
    }
)
...
result4 = tu.run(
    {
        "name": "EuropePMC_search_articles",
        "arguments": {"query": "Smith", "limit": 2, "search_fields": ["author"]},
    }
)
...
result5 = tu.run(
    {
        "name": "EuropePMC_search_articles",
        "arguments": {"query": "neuroscience", "limit": 3, "journal": "Nature"},
    }
)
...
def extract_article_info(result):
    ...
    return {
        ...
        "abstract": first_article.get("abstract", "N/A")[:200] + "..."
...
europepmc_queries = [
    {
        "name": "EuropePMC_search_articles",
        "arguments": {"query": "bioinformatics", "limit": 2},
    },
    {
        "name": "EuropePMC_search_articles",
        "arguments": {"query": "genomics", "limit": 2},
    },
]
...
quick_result = tu.run(
    {
        "name": "EuropePMC_search_articles",
        "arguments": {"query": "pharmacology", "limit": 1},
    }
)
...
comprehensive_result = tu.run(
    {
        "name": "EuropePMC_search_articles",
        "arguments": {"query": "pharmacology", "limit": 10},
    }
)
