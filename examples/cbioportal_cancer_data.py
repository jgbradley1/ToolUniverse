...
def main():
    ...
    result = tu.run(
        {"name": "cBioPortal_get_cancer_studies", "arguments": {"limit": 5}}
    )
    ...
    result = tu.run(
        {"name": "cBioPortal_get_cancer_studies", "arguments": {"limit": 10}}
    )
    ...
    result = tu.run(
        {"name": "cBioPortal_get_cancer_studies", "arguments": {"limit": 8}}
    )
