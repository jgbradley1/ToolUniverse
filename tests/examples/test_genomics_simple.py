...
class TestGenomicsSimple(unittest.TestCase):
    ...
    def test_get_go_annotations(self):
        ...
        # Test with a known gene
        annotations = GO_get_annotations_for_gene(gene_id="ENSG00000012048")
    ...
    def test_pathway_enrichment(self):
        ...
        enrichment = enrichr_gene_enrichment_analysis(
            gene_list=genes, libs=["KEGG_2021_Human"]
        )
        ...
        self.assertTrue(
            enrichment is None
            or enrichment is False
            or isinstance(enrichment, (list, dict, tuple))
        )
